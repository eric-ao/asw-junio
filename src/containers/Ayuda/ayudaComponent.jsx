    ...
    render() {
        ...
        return (
            <div className="ayuda-Component">
                ...
                <p>Para compartir una ruta deberá ir a la pestaña rutas. Una vez ahi seleccionar la ruta la cual quiere compartir por ejemplo "Primera ruta". Una vez seleccionada le aparecerá compartir ruta, pulse y le aparecerá un cuadro de texto indicando que se ha compartido correctamente </p>
